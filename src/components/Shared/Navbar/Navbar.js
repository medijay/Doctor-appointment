          ...
          <div className="container-fluid">
             ...
             <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav mb-2 mb-lg-0 ms-auto">
                    ...
                    <li className="nav-item">
                        <a className="nav-link me-3" href="#doctorContents">ABOUT</a>
                    </li>
                    <li className="nav-item">
                        <a href='#ContactPage' className="nav-link me-3">CONTACT</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link me-3 textDark" href="#BlogContents">BLOG</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link me-3 textDark" href="#serviceContents">DENTAL SERVICES</a>
                    </li>

                    <li className="nav-item">
                        <a className="nav-link me-3 textDark" href="#reviewsContents">REVIEWS</a>
                    </li>
